...
class _WidgetSliderState extends State<WidgetSlider>
  ...
  Widget build(BuildContext context) {
    List<Widget> children = [
      AnimatedBuilder(
        ...
        builder: (context, child) => SizeTransition(
          sizeFactor: _size,
          axisAlignment: widget.direction == ArrowDirection.down ||
                  widget.direction == ArrowDirection.right
              ? 1.0
              : -1.0,
          axis: widget.direction == ArrowDirection.down ||
    ...
    if (widget.direction == ArrowDirection.up ||
